...
#define _INTERVAL_SERVO   1125 // servo interval (unit: ms)
#define _INTERVAL_SERIAL  2250 // serial interval (unit: ms)
...
#define _DUTY_MIN 1054 // 1000

#define _SERVO_ANGLE_DIFF  108  // Replace with |D - E| degree   98 - (-10)
...
float volt_to_distance(int a_value)
{
  ...
  return 944 -4.71*a_value + 8.8*pow(10,-3)*pow(a_value,2) -5.87*pow(10,-6)*pow(a_value,3);
}
